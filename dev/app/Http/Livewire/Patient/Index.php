...
class Index extends Component
{
    ...
    {
        $query = Patient::with(['role', 'user', 'gender', 'ethnicity', 'contactMethod', 'contactTime', 'distance', 'owner'])->advancedFilter([
            's'               => $this->search ?: null,
        ...
        return view('livewire.patient.index', compact('query', 'patients', 'patients'));
    }
